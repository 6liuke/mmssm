...
<%--            ajaxsplit(${info.pageNum})--%>
    ...
    <div id="table">
        ...
        <c:choose>
            ...
            <c:otherwise>
                <div>
                    <h2 style="width:1200px; text-align: center;color: #ff4500;margin-top: 100px">暂时没有符合条件的商品！</h2>
                </div>
            </c:otherwise>
        </c:choose>
    </div>
...
<script type="text/javascript">
    ...
    function deleteBatch() {
            ...
            if(zhi.length==0){
                ...
                //拼接ID
                    ...
                    // alert(str+"11111111");
                    //发送请求到服务器端
                   // window.location="${pageContext.request.contextPath}/prod/deleteBatch.action";
                    $.ajax({
    ...
    function one(pid, page) {
        ...
        var lprice = $("#lprice").val();
        var hprice = $("#hprice").val();
        var str = "?pid="+pid+"&page="+page+"&typeid="+typeid+"&lprice="+lprice+"&hprice="+hprice;
